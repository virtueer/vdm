import { DownloadCloud, ListFilter, Search, XCircle } from 'lucide-react';
    ...
    <Card className="mb-3">
      <CardContent className="p-3">
        <div className="flex items-center gap-2">
          <Button onClick={() => setShowManualInput(!showManualInput)} className="gap-2 shrink-0">
            ...
            <>
              ...
              {isYouTubeUrl(manualUrl) && (
                <Button
                  variant="default"
                  onClick={() =>
                    onOpenFormatModal({ url: manualUrl.trim(), title: manualTitle.trim() })
                  }
