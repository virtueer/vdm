import { Check, Copy, Terminal, XCircle } from 'lucide-react';
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-zinc-900/90 border-b border-zinc-800/80">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 text-zinc-300">
            ...
            <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-zinc-800 text-zinc-400 font-mono font-medium">
              {logs.length} lines
            </span>
          </div>
        </div>
      ...
      <ScrollArea className="flex-1 p-3">
        <div className="space-y-0.5 pb-4">
          {logs.length === 0 ? (
            <div className="text-zinc-600 font-mono text-xs italic py-2">
